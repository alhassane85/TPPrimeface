...
public class BoutiqueDaoImpl implements IBoutiqueDao {
	...
	/*
	 * @Override public void ajouterUser(User u) { em.persist(u); }
	 */
	/*
	 * @Override public void attribuerRole(Role r, Long userID) { User
	 * u=em.find(User.class, userID); r.setUser(u); em.persist(r); }
	 */
	@Override
